...
namespace LocalMultiplayerMod
{
    ...
    internal static class TeleportProbe
    {
        ...
        /// <summary>
        /// Installed regardless of the setting, and silent unless it is on. The
        /// patch has to be in place before the level loads, but whether the probe
        /// is wanted can be decided later - including by editing the settings file
        ...
        )
        {
            ...
            PlayerContext context = PlayerScope.Current;
            if (!ModEntry.Diagnostics.Teleport || context == null ||
                behaviourContext == null || behaviourContext.BodyComp == null)
            {
                return false;
            }
